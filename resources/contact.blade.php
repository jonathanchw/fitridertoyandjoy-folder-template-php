...
<div class="py-5">
      <div class="container">
        ...
        <p><span class="js_website-name">{{ $content -> store_name}}</span></p>
        <p><span class="js_website-corp">{{$page->corporation->name}}</span></p>
        ...
        <p><span class="js_website-address">{!! empty($page->support_return_address) ? '' : nl2br(e($page->support_return_address)) !!}</span></p>
        <p><b>Returns</b></p>
        <p><span class="js_website-return-partner">{{$page->corporation->name}}</span></p>
