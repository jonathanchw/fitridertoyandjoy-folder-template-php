...
<div class="py-5">
    <div class="container">
        ...
        <p>
            This website is operated by <span class="js_website-name"></span>.
            Throughout the site, the terms “we”, “us” and “our” refer to
            <span class="js_website-name"></span>.
            <span class="js_website-name"></span> offers this website, including
        ...
        <p>
            ...
            to be 3-5 business days. Please be advised that shipments are not sent
            on Saturdays, Sundays, or any Holidays.
            <span class="js_website-name"></span> does not guarantee specific
        ...
        <p>
            You may contact our customer care department by using our toll free
            phone number. Toll Free Customer Care phone:
            <a href="" class="js_website-phone"></a>.
        </p>
        <p id="returns">RETURNS</p>
        <p>
            To return an item, please email customer service at
            <a href="" class="js_website-email"></a> to obtain a Return
            Merchandise Authorization (RMA) number. After receiving a RMA number,
            place the item securely in its original packaging [and include your
            proof of purchase], and mail your return the following address:
        </p>
        ...
        <p>REFUNDS</p>
        <p>
            We will refund when the received package containing the originally
            ordered product(s), either opened or unopened, postmarked within 30
            days of the received date and the included RMA number obtained from
            customer service. We refund all cases of fraud and unauthorized
            transactions included shipping and handling charges. Customers are
            restricted to receiving a single refund per product ordered.
            Repetitive refunds are not permitted unless the product, as delivered
            ...
            requests refunds in bad faith. In order to process your refund, you
            must supply us with your name and delivery address. If you provide us
            with insufficient or incorrect information your refund will be
            delayed. Once a refund has been approved please allow for up to 5
            business days for refund to apply. Depending on the bank that issued
            the credit card, your refund can take up to 5 business days to appears
            on your credit card statement. If you have any questions about whether
            a refund has been issued by us, please call our customer service
            department. Shipping and handling costs are not refundable.
        </p>
        ...
        <p>
            ...
            In no case shall <span class="js_website-name"></span>, our directors,
        ...
        <p>
            ...
            <span class="js_website-name"></span> and our parent, subsidiaries,
